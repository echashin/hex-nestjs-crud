...
} from "../../../../shared/api/core/data-contracts";
import {GetFieldFromObject} from "../../helpers/get-field-from-object";
...
export class CrudComponent<T extends { id: string }> extends ResizableTableComponent implements OnInit {
  constructor(
    private readonly router: Router,
    public override nzImageService: NzImageService,
    private readonly route: ActivatedRoute,
    public override readonly elRef: ElementRef<HTMLElement>,
  ) {
    super(elRef, nzImageService);
  }
  ...
  override crudConfig: Required<CrudConfig> = {
    ...
    onCreate: (input: any): Observable<any> | undefined => {
      return this._service.create ? this._service.create(input) : undefined;
    },
    onFind: (input: FindInput): Observable<any> | undefined => {
      return this._service.find({...input});
    },
    formWidth: 600,
    formBundleWidth: 600,
    single: 's',
  ...
  createFormOutputs: DynamicFormOutputs = {
    formSubmit: (value: any): void => this.createItem(value),
  ...
  updateFormOutputs: DynamicFormOutputs = {
    formSubmit: (value: any): void => this.updateItem(value),
    formValueChanges: (value: any): void => alert(value),
  };
  ...
  updateManyFormOutputs: DynamicFormOutputs = {
    formSubmit: (value: any): void => this.updateMany(value),
    formValueChanges: (value: any): void => alert(value),
  };

  filterFormOutputs: DynamicFormOutputs = {
    formValueChanges: (value: any): void => this.filter(value),
    formSubmit: (value: any): void => this.filterFormChange(value),
  };
      ...
      this._service
        ...
        .subscribe(() => {
          ...
          this.router.navigate([], {
            queryParams: {[this.queryNameWithEditId]: undefined},
  ...
  loadOne(id: string): void {
    if (this._service.findOne) {
      this._service
        .findOne(id, {...(this.joinForForms && {join: this.joinForForms})})
        .pipe(untilDestroyed(this), take(1))
        .subscribe((value: T) => {
