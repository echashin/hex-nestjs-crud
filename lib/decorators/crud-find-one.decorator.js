...
const CrudFindOne = (entity) => {
    ...
    }), (0, swagger_1.ApiExtraModels)(inputs_1.FindOneInput), (0, common_1.UseInterceptors)(crud_request_interceptor_1.CrudRequestInterceptor, common_1.ClassSerializerInterceptor), (0, swagger_1.ApiOkResponse)({
        schema: {
            title: `${entity.name}`,
