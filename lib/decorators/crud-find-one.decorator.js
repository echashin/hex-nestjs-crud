...
const CrudFindOne = (entity) => {
    ...
    }), (0, common_1.UseInterceptors)(crud_request_interceptor_1.CrudRequestInterceptor, common_1.ClassSerializerInterceptor, crud_request_soft_delete_interceptor_1.CrudRequestSoftDeleteInterceptor), (0, swagger_1.ApiOkResponse)({
        schema: {
            title: `${entity.name}`,
