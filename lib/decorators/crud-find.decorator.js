...
const CrudFind = (entity, path = "") => {
    return (0, common_1.applyDecorators)((0, common_1.Get)(path), (0, api_paginated_response_1.ApiPaginatedResponse)(entity), (0, swagger_1.ApiExtraModels)(entity), (0, swagger_1.ApiExtraModels)(dto_1.Pageable, inputs_1.FindInput), (0, swagger_1.ApiOperation)({
