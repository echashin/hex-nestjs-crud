...
const crud_request_soft_delete_interceptor_1 = require("../interceptors/crud-request-soft-delete.interceptor");
const api_paginated_response_1 = require("./api-paginated-response");
const CrudFind = (entity, path = "") => {
    return (0, common_1.applyDecorators)((0, common_1.Get)(path), (0, api_paginated_response_1.ApiPaginatedResponse)(entity), (0, swagger_1.ApiExtraModels)(entity), (0, swagger_1.ApiOperation)({
        summary: `Retrieve multiple items ${entity.name}[]`,
        description: "find",
    }), (0, common_1.UseInterceptors)(crud_request_interceptor_1.CrudRequestInterceptor, common_1.ClassSerializerInterceptor, crud_request_soft_delete_interceptor_1.CrudRequestSoftDeleteInterceptor), (0, swagger_1.ApiQuery)({
        name: "fields",
        required: false,
        type: String,
        isArray: false,
