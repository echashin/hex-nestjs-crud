...
const CrudCreate = (model) => {
    return (0, common_1.applyDecorators)((0, swagger_1.ApiOperation)({ summary: `Create one item ${model.name}` }), (0, swagger_1.ApiExtraModels)(model), (0, swagger_1.ApiExtension)('x-crud-method', { type: crud_methods_enum_1.CrudMethodsEnum.create }), (0, swagger_1.ApiCreatedResponse)({
        schema: {
            title: `${model.name}`,
