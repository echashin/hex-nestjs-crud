...
function CrudExport(path = "export") {
    return (0, common_1.applyDecorators)((0, common_1.Get)(path), (0, swagger_1.ApiOperation)({ summary: `Export items to file` }), (0, common_1.UseInterceptors)(export_content_type_interceptor_1.ExportContentTypeInterceptor), (0, swagger_1.ApiExtension)('x-crud-method', { type: crud_methods_enum_1.CrudMethodsEnum.export }), (0, swagger_1.ApiExtraModels)(inputs_1.ExportFileInput), (0, swagger_1.ApiQuery)({
        name: "ids",
        required: false,
        type: String,
        isArray: true,
